...
const DropdownRegister: React.FC<DropdownRegisterProps> = ({ selectedStatus, setSelectedStatus }) => {
    ...
    return (
        <div>
            ...
            >
                ...
                <MenuItem onClick={() => handleMenuItemClick("Aguardando Ativação")} disableRipple>
                    Aguardando Ativação
                </MenuItem>
                <MenuItem onClick={() => handleMenuItemClick("Desativado")} disableRipple>
                    Desativado
                </MenuItem>
            </StyledMenu>
        </div>
