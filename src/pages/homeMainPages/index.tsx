                ...
                <section className="flex flex-col mx-auto">
                    ...
                    <div className="flex justify-between">
                        <div>
                            ...
                            <p className="mb-14">Escolha um cliente para visualizar os detalhes</p>
                        </div>
                        <button type="submit" className="bg-orange-500 hover:bg-orange-600 text-white font-bold py-2 px-4 rounded w-36 h-12"><Link to="/register">Novo cliente</Link></button>
                    </div>
                    <CardsClients />
                </section>
            </div>
